...
from processing_iadb.utils import sph_executable, generate_batch_file, execute
...
class CalculateLandslide(IadbAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterFile(self.DEM, self.tr("DEM file")))
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        file_name = os.path.split(dem)[1]
        dem_file_name = os.path.join(sph_path, file_name)
